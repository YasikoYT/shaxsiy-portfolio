    ...
    <div className={`rounded-3xl p-5 sm:p-8 border shadow-2xl transition-all space-y-8 ${
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-black/10 dark:border-white/10">
        <div className="space-y-1.5">
          ...
          <p className={`text-xs font-sans max-w-xl ${isDarkMode ? "text-neutral-400" : "text-neutral-600"}`}>
            Barcha o'yinlardagi natijalaringiz brauzer xotirasida (localStorage) va serverda avtomatik saqlanadi. Istalgan o'yin yonidagi <strong>"O'ynash"</strong> tugmasini bosib rekord o'rnatishingiz mumkin.
          </p>
        </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] font-mono text-neutral-400">Eng yuqori natija ko'rsatgan 3 ta o'yin</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
          ...
          {podium2 && (
            <motion.div
              ...
              className={`p-5 rounded-3xl border relative overflow-hidden transition-all hover:scale-[1.02] shadow-xl ${
                isDarkMode 
                  ? "bg-gradient-to-b from-slate-900 to-[#12172a] border-slate-700/60" 
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-slate-500/20 text-slate-400 font-extrabold">
                  {podium2.badge}
                </span>
              </div>
              <div className="space-y-1 my-2">
                <h5 className={`font-serif text-lg font-bold truncate ${isDarkMode ? "text-white" : "text-slate-900"}`}>
                  {podium2.name}
                </h5>
                <div className="text-xl font-mono font-black text-slate-300 flex items-center gap-1.5">
          ...
          {podium1 && (
            <motion.div
              ...
              className={`p-6 rounded-3xl border-2 relative overflow-hidden transition-all hover:scale-[1.03] shadow-2xl md:-translate-y-2 ${
                isDarkMode 
                  ? "bg-gradient-to-b from-amber-950/80 via-[#1e170a] to-[#0f1118] border-amber-500/70 shadow-amber-500/10" 
                  : "bg-gradient-to-b from-amber-50 via-yellow-100 to-amber-100 border-amber-400 shadow-amber-500/20"
              }`}
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/10 rounded-full blur-2xl pointer-events-none" />
              <div className="flex items-center justify-between mb-3 relative z-10">
                <span className="px-3.5 py-1 bg-amber-500 text-black font-mono font-black text-xs rounded-full flex items-center gap-1.5 shadow-md">
                  <Crown className="w-4 h-4 fill-black" /> 🥇 1-O'RIN CHAMPION
                </span>
                <span className="text-[10px] font-mono px-2.5 py-0.5 rounded-full bg-amber-500/20 text-amber-400 font-extrabold border border-amber-500/40">
                  {podium1.badge}
                </span>
              </div>
              <div className="space-y-1.5 my-3 relative z-10">
                <h5 className={`font-serif text-xl font-extrabold truncate ${isDarkMode ? "text-amber-300" : "text-amber-950"}`}>
                  {podium1.name}
                </h5>
          ...
          {podium3 && (
            <motion.div
              ...
              className={`p-5 rounded-3xl border relative overflow-hidden transition-all hover:scale-[1.02] shadow-xl ${
                isDarkMode 
                  ? "bg-gradient-to-b from-[#24160e] to-[#12131c] border-amber-900/60" 
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-amber-700/20 text-amber-400 font-extrabold">
                  {podium3.badge}
                </span>
              </div>
              <div className="space-y-1 my-2">
                <h5 className={`font-serif text-lg font-bold truncate ${isDarkMode ? "text-white" : "text-amber-950"}`}>
                  {podium3.name}
                </h5>
                <div className="text-xl font-mono font-black text-amber-500 flex items-center gap-1.5">
                    ...
                    <div className={`p-3 rounded-xl border flex items-center justify-between gap-2 ${
                      ...
                      {score > 0 && (
                        <div className="text-right shrink-0">
                          <div className="text-[9px] font-mono text-neutral-400">O'yinchi</div>
                          <div className="text-xs font-mono font-bold text-amber-500 flex items-center gap-1">
                            <User className="w-3 h-3 text-amber-500" /> {playerName}
                          </div>
                        </div>
                      )}
                    </div>
